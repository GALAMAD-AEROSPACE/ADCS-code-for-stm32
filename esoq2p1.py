...
if __name__ == "__main__":
    # Example data: 3 corresponding vectors in body and inertial frames
    ...
    # Compute the optimal quaternion using ESOQ2
    q_opt, loss = esoq2p1(body_vectors.T, inertial_vectors.T, weights)
